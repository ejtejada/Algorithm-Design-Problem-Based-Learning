...
\begin{axis}[
    axis lines = left,
    xlabel = $n_0 \rightarrow n$,
    ylabel = {Operations},
    title = \textbf{Asymptotic Upper Bound} ,
]
...
\begin{axis}[
    ...
    xlabel = $n_0 \rightarrow n$,
    ylabel = {Operations},
    title = \textbf{Asymptotic Lower Bound} ,
]
...
{(1/10)*(x^2 + 100)};
\addlegendentry{f(n) : $c\cdot(n^2 + 100)$}
\end{axis}
\end{tikzpicture}
\textbf{Solution: } 
